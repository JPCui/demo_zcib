<%@page import="cn.zcib.bean.Punish"%>
...
<link rel="stylesheet" rev="stylesheet" href="__PUBLIC__/css/style.css" type="text/css" media="all" />
<style type="text/css">
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >惩罚记录</th>
  </tr>
  <tr>
    <td class="CPanel">		
			...
			<TD width="100%">
				...
				<legend>记录列表</legend>
					<table align="center" id="mytable" >
						<tr>
							<td width="200" align="center" valign="middle">惩罚名称</td>
							<td width="200" align="center" valign="middle">惩罚级别</td>
						...
						<tr>
							<td width="200" align="center" valign="middle">${l.punishName }</td>
							<td width="200" align="center" valign="middle"><%=((Punish)request.getAttribute("l")).getRank() %></td>
